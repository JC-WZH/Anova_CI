...
#data = pd.DataFrame(pd.read_excel("D:/匹配/scorebefore.xlsx"))
data = pd.DataFrame(pd.read_excel("scorebefore.xlsx"))
...
Y=np.concatenate((Sd0,Sd1))

print(Sd0.value_counts())
print(Sd1.value_counts())

#Y=Sd0
#Y.append(Sd1)
ar,num=np.unique(Y, return_counts=True)
